...
$date = date("D",$time);
echo "this is format D = " . $date."<br/>";//Sun/mon....

$date = date("F",$time);
echo "this is format F = " . $date."<br/>";//December/January....

$date = date("g",$time);
echo "this is format g = " . $date."<br/>";//hour by num(by 12hr no leading 0)

$date = date("G",$time);
echo "this is format G = " . $date."<br/>";//hour by num(by 24hr no leading 0
...
$date = date("n",$time);
echo "this is format n = " . $date."<br/>";//month by num(no leadign zero)
...
$date = date("y",$time);
echo "this is format y = " . $date."<br/>";//year(two digit)

$date = date("Y",$time);
echo "this is format Y = " . $date."<br/>";//year (four digit)

$date = date("z",$time);
echo "this is format z = " . $date."<br/>";//day of year(365)
